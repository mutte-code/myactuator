...
from myactuator_lib.message import Message
...
class Motor():
	...
	def _create_can_message(self, created_can_data: CanData) -> Message:
	...
	def Read_PID_parameter_command(self) -> Message:
		can_data_constructor = CanData(0x30,[])
		return self._create_can_message(can_data_constructor)

	def Write_PID_parameters_to_RAM_command(self, current_P_gain, current_I_gain, speed_P_gain, speed_I_gain, pos_P_gain, pos_I_gain) -> Message:
		range_vals = (0,256)
		can_parameters = []
	...
	def Write_PID_parameters_to_ROM_command(self, current_P_gain, current_I_gain, speed_P_gain, speed_I_gain, pos_P_gain, pos_I_gain) -> Message:
		range_vals = (0,256)
		can_parameters = []
		can_parameters.append(CanDataParameter(current_P_gain,range_vals,2,1))
		can_parameters.append(CanDataParameter(current_I_gain,range_vals,3,1))
	...
	def Read_acceleration_command(self) -> Message:
		can_data_constructor = CanData(0x42,[])
		return self._create_can_message(can_data_constructor)

	def Write_acceleration_to_RAM_and_ROM_command(self, acceleration_degrees_per_sec_per_sec) -> Message:
		can_parameters = []
	...
	def Read_multi_turn_encoder_position_data_command(self) -> Message:
		can_data_constructor = CanData( 0x60 ,[])
		return self._create_can_message(can_data_constructor)

	def Read_multi_turn_encoder_zero_offset_data_command(self) -> Message:
		can_data_constructor = CanData(0x62,[])	
		return self._create_can_message(can_data_constructor)

	def Read_single_turn_encoder_command(self) -> Message:
		can_data_constructor = CanData(0x90 ,[])
		return self._create_can_message(can_data_constructor)

	def Read_multi_turn_angle_command(self) -> Message:
		can_data_constructor = CanData(0x92 ,[])
		return self._create_can_message(can_data_constructor)

	def Read_single_turn_angle_command(self) -> Message:
		can_data_constructor = CanData(0x94,[])
		return self._create_can_message(can_data_constructor)

	def Read_Motor_Status_1_and_Error_Flag_Command(self) -> Message:
		can_data_constructor = CanData(0x9A ,[])
		return self._create_can_message(can_data_constructor)

	def Read_Motor_Status_2_Command(self) -> Message:
		can_data_constructor = CanData(0x9C,[])
		return self._create_can_message(can_data_constructor)

	def Read_Motor_Status_3_Command(self) -> Message:
		can_data_constructor = CanData(0x9D ,[])
		return self._create_can_message(can_data_constructor)

	def Motor_shutdown_command(self) -> Message:
		can_data_constructor = CanData(0x80,[])
		return self._create_can_message(can_data_constructor)

	def Motor_stop_command(self) -> Message:
		can_data_constructor = CanData(0x81,[])
		return self._create_can_message(can_data_constructor)

	def Torque_closed_loop_control_command(self, torque_current_mA) -> Message:
		can_parameters = []
		can_parameters.append(CanDataParameter(torque_current_mA,(0,32767),4,2))
		can_data_constructor = CanData(0xA1,can_parameters)
		return self._create_can_message(can_data_constructor)

	def Speed_Closed_loop_Control_Command(self, speed_control_degrees_per_second) -> Message:
	...
	def Absolute_position_closed_loop_control_command(self, speed_limit, position_control) -> Message:
		can_parameters = []
	...
	def Single_turn_position_control_command(self, rotation_direction, speed_limit, position_control) -> Message:
		can_parameters = []
	...
	def System_operating_mode_acquisition(self) -> Message:
		can_data_constructor = CanData(0x70 ,[])
		return self._create_can_message(can_data_constructor)

	def Motor_power_acquisition(self) -> Message:
		can_data_constructor = CanData(0x71,[])
		return self._create_can_message(can_data_constructor)

	def System_reset_command(self) -> Message:
		can_data_constructor = CanData(0x76,[])
		return self._create_can_message(can_data_constructor)

	def System_brake_release_command(self) -> Message:
		can_data_constructor = CanData(0x77,[])
		return self._create_can_message(can_data_constructor)

	def System_brake_lock_command(self) -> Message:
		can_data_constructor = CanData(0x78,[])	
		return self._create_can_message(can_data_constructor)

	def System_runtime_read_command(self) -> Message:
		can_data_constructor = CanData(0xB1,[])
		return self._create_can_message(can_data_constructor)

	def System_software_version_date_read_command(self) -> Message:
		can_data_constructor = CanData(0xB2,[])
		return self._create_can_message(can_data_constructor)

	def Communication_baud_rate_setting_command(self, baudrate) -> Message:
		can_parameters = []
		can_parameters.append(CanDataParameter(baudrate,(0,1),7,1))
		can_data_constructor = CanData(0xB4,can_parameters)
		return self._create_can_message(can_data_constructor)

	def Motor_model_reading_command(self) -> Message:
